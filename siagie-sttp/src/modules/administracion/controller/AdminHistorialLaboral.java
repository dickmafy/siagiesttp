...
public class AdminHistorialLaboral extends GenericController   
{
	...
	public void init(Long id, String nom) throws Exception
	{
		...
		page_new="prs_lab_new";
		page_main="prs_lab_list";
		page_update="prs_lab_update";
		forward(page_main);
	}
	...
	public boolean validation() throws Exception 
	{
		...
		{
			setMessageError("Debe seleccionar el Tipo de Instituci�n.");			
			success = false;
		}
		else if(!validateSelect(object.getInstitucion()))
		{
			setMessageError("Debe seleccionar la Instituci�n.");			
			success = false;
		}
		...
		{
			setMessageError("Debe ingresar la Funci�n Principal.");			
			success = false;
		}
