...
public class AdmisionProceso extends GenericController   
{
    ...
    public boolean validation() throws Exception 
    {
        ...
        {
                setMessageError("Debe ingresar el costo del registro al proceso de admisi�n.");                 
                success = false;
        }
	...
	public void optionPublicar() throws Exception
	{
		...
		setMessageSuccess("El proceso fue publicado exit�samente, el proceso de registro de postulantes se encuentra habilitado.");
		defaultList();		
		bean=null;
	}
	...
	public void optionMatricula() throws Exception
	{
		...
		setMessageSuccess("El proceso ha registrado el Inicio de la Etapa de Matricula exit�samente.");
		defaultList();
		bean=null;
	}
	public void optionAcademica() throws Exception
	{
		...
		setMessageSuccess("El proceso ha registrado el Inicio de la Etapa Acad�mica exit�samente.");		
		defaultList();
		bean=null;
	}
	public void optionFinalizar() throws Exception
	{
		...
		setMessageSuccess("El proceso se ha finalizado exit�samente.");
		defaultList();
		bean=null;
	}
	...
	public void optionAnular() throws Exception
	{
		...
		setMessageSuccess("El proceso fue anulado exit�samente.");
		defaultList();
		bean=null;
	}
