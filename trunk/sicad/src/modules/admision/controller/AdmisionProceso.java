...
public class AdmisionProceso extends GenericController   
{
	...
	public void optionPublicar() throws Exception
	{
		...
		setMessageSuccess("El proceso fue publicado exit�samente, el proceso de registro de postulantes esta habilitado.");
		defaultList();		
		bean=null;
	}
	...
	public void optionAcademica() throws Exception
	{
		...
		setMessageSuccess("El proceso ha registrado el Inicio de la Etapa de Academica exit�samente.");
		defaultList();
		bean=null;
	}
