...
public class MarcoOcupacion extends GenericController   
{	
	...
	public void init() throws Exception 
	{
		...
		moduleName="Ocupacional";
		userName=usr.getUsuario();
		
		defaultList();
		page_new="ocup_new";
		page_main="ocup_list";
		page_update="ocup_update";
		forward(page_main);
	}
	...
	public void optionGoProductivo() throws Exception
	{
		...
		go.init(((Profesion)getBeanSelected()).getId().longValue(), ((Profesion)getBeanSelected()).getNombre(), "ocup_list");
	}
