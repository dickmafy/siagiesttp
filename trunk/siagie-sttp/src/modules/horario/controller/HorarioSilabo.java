...
public class HorarioSilabo extends GenericController   
{
	...
	public void init(Long ann, Long prc, Long prf, Long trn) throws Exception
	{
		...
		defaultList();
		page_new="hor_meta_sil";
		page_main="hor_meta_sil";
		page_update="hor_meta_sil";
		forward(page_main);
	}
	...
	public void defaultList() throws Exception
	{
		...
		{setBeanList(myService.listarSilabos(institucion, annio, proceso, profesion, turno));}
		else
		{setBeanList(new ArrayList<Seccion>());}
	}
	
	public void optionApprove() throws Exception
	{
		Seccion bean=(Seccion)getBeanSelected();
		myService.updateStatus(bean, 3L);
		defaultList();
		setMessageSuccess("El silabo fue aprobado exitosamente.");
	}
	
	public void optionDisapprove() throws Exception
	{
		Seccion bean=(Seccion)getBeanSelected();
		myService.updateStatus(bean, 0L);
		defaultList();
		setMessageSuccess("El silabo fue rechazado exitosamente.");
	}
