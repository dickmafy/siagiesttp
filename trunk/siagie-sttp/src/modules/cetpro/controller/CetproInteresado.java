...
@ManagedBean
@SessionScoped
public class CetproInteresado extends GenericController   
{	 
	...
	public void init() throws Exception 
	{
		...
		defaultList();
		page_new="cetpro_interesado_new";
		page_main="cetpro_interesado_list";
		page_update="cetpro_interesado_update";
