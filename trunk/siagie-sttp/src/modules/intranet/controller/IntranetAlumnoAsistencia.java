...
public class IntranetAlumnoAsistencia extends GenericController   
{	
	...
	public void init() throws Exception 
	{
		...
		profesion=101L;
		nombreUnidad= "Prueba";
		page_new="IntranetAlumnoAsistencia_new";
		page_update="IntranetAlumnoAsistencia_update";
		page_main="IntranetAlumnoAsistencia_list";
		//defaultList();		
		forward(page_main);
		optionCriterios();
	}
